...
namespace SubtitleTranslator.Tests
{
    ...
    {
        /// <summary>
        /// Tests that GenerateOutputFileName creates a proper filename with '_translated' suffix.
        /// </summary>
        [Fact]
        public void GenerateOutputFileName_ShouldAddTranslatedSuffix()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void GenerateOutputFileName_WithoutExtension_ShouldAddTranslatedSuffix()
        {
            // Arrange
